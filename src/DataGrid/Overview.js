...
import DSButton from "@elliemae/ds-basic/esm/Button";
          ...
          return (
            <>
              <Ul>
                <Li>{description}</Li>
                <Li>
                  Requires a minimum *2-months PITI reserves for any other
                  Second Home or any 1-4 investment Property owned
                </Li>
                <Li>
                  A foreclosure requires a seven-year waiting period from the
                  completion date of the foreclosure action. A three-year
                  waiting period is permitted if extenuating circumstances can
                  be documented.
                </Li>
                <Li>
                  If this is a Community Second the Subordinate Financing LLPA
                  does not apply.
                </Li>
                <Li>
                  Mortgage insurance adjustments may apply based on /r coverage
                  %. Please see Pricing Desk.
                </Li>
              </Ul>
            </>
          );
